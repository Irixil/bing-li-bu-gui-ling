...
**已知覆盖缺口**：第 2 条包含心率 40 次/分钟，现已增加 `low_heart_rate_candidate` 待专业复核标记；它仍不单独触发急救规则，`expected_local_danger=false` 的原标签保留且不代表医学正常。候选阈值和适用情境尚待医学审核。第 3 条同样不能用于“没危险”的判断。第 1 条会触发胸闷/呼吸困难规则。演示应同时说明关键词范围有限。
