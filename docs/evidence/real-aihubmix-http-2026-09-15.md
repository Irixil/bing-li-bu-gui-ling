...
> 历史失败记录：2026-09-16 已确认当前 Key 的可用模型列表不含 Whisper，并改用同一 Key 已开放的 `gemini-2.5-flash-lite`。新的单次合成 WAV 真实请求已成功，见 [2026-09-16 语音验证](real-aihubmix-gemini-audio-2026-09-16.md)。以下保留当日原始结论，不是当前建议。
